...
class CasinoGameList extends BaseModel
{
    ...
    public function saveItem($data, $admin)
    {
        ...
        $this->pc_game_code                 = $data['pc_game_code'] ?? '';
        $this->pc_game_deputy_code          = $data['pc_game_deputy_code'] ?? '';
        $this->mobile_game_code             = $data['mobile_game_code'] ?? '';
        $this->mobile_game_deputy_code      = $data['mobile_game_deputy_code'] ?? '';

        $this->record_match_code            = $data['record_match_code'] ?? '';
        $this->record_match_deputy_code     = $data['record_match_deputy_code'] ?? '';
        ...
        $this->able_demo                    = $data['able_demo'] ?? '';
        $this->able_recommend               = $data['able_recommend'] ?? '';
